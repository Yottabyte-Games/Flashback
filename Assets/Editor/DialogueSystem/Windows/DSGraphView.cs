...
namespace DS.Windows
{
    ...
    public class DSGraphView : GraphView
    {
        ...
        SerializableDictionary<string, DSNodeErrorData> _ungroupedNodes;
        SerializableDictionary<string, DSGroupErrorData> _groups;
        SerializableDictionary<Group, SerializableDictionary<string, DSNodeErrorData>> _groupedNodes;
