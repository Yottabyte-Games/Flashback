...
namespace ArcadeVehiclePhysics.Vehicle.Scripts.CP___CarPhysics
{
    public class CpAcceleration : MonoBehaviour
    {
        ...
        void CalculateSpeedData(Rigidbody rb, VehicleSpeed speedData)
        {
        ...
        float GetForceFromVelocityForceCurve(AnimationCurve velocityForceCurve, PlayerInputs input,
        ...
        float BinarySearchDisplay(AnimationCurve velTimeCurve, float currentVel)
        {
        ...
        void ApplyAcceleration(float accelToApply, Rigidbody rb, bool grounded)
        {
            if (!grounded)
                return;
