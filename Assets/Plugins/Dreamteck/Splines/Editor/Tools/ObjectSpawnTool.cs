namespace Dreamteck.Splines.Editor
{
    ...
    public class ObjectSpawnTool : SplineTool
    {
        ...
        Vector3 minRotationOffset = Vector3.zero;
        Vector3 maxRotationOffset = Vector3.zero;
        Vector3 minScaleMultiplier = Vector3.one;
        Vector3 maxScaleMultiplier = Vector3.one;
        bool randomizeOffset = false;
        bool useRandomOffsetRotation = false;
        bool shellOffset = true;
