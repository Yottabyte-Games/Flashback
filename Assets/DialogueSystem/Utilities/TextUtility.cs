...
{
	public static bool IsWhitespaceCharacter(this char character)
	{
		switch (character)
		{
			case '\u0020':
    ...
    public static string RemoveWhitespaces(this string text)
    {
	    ...
	    for (var currentCharacterIndex = 0; currentCharacterIndex < textLength; ++currentCharacterIndex)
	    {
		    ...
		    if (currentTextCharacter.IsWhitespaceCharacter())
		    {
			    continue;
		    }
	...
	public static string RemoveSpecialCharacters(this string text)
    {
        ...
        for (var currentCharacterIndex = 0; currentCharacterIndex < textLength; ++currentCharacterIndex)
        {
            ...
            if (!char.IsLetterOrDigit(currentTextCharacter) && !currentTextCharacter.IsWhitespaceCharacter())
            {
                textCharacters[currentWhitespacelessTextLength++] = currentTextCharacter;
            }
        }
