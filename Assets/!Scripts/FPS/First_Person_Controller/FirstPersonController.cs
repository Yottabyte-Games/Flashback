...
using _Scripts.FPS.Camera_Controller;
using _Scripts.FPS.Scriptable_Objects;
using NaughtyAttributes;
using UnityEngine;

namespace _Scripts.FPS.First_Person_Controller
{
        ...
        #region Variables
            #region Private Serialized     
                #region Data
                    [Space, Header("Data")]
                    [SerializeField]
                    MovementInputData movementInputData = null;
                    [SerializeField] HeadBobData headBobData = null;
                ...
                #region Locomotion
                    ...
                    [MinMaxSlider(0f,1f)][SerializeField] float moveBackwardsSpeedPercent = 0.5f;
                    [MinMaxSlider(0f,1f)][SerializeField] float moveSideSpeedPercent = 0.75f;
                #endregion

                #region Run Settings
                    [Space, Header("Run Settings")]
                    [MinMaxSlider(-1f,1f)][SerializeField]
                    float canRunThreshold = 0.8f;
                ...
                #region Crouch Settings
                    ...
                    [MinMaxSlider(0.2f,0.9f)][SerializeField]
                    float crouchPercent = 0.6f;
                ...
                #region Landing Settings
                    ...
                    [MinMaxSlider(0.05f,0.5f)][SerializeField]
                    float lowLandAmount = 0.1f;
                    [MinMaxSlider(0.2f,0.9f)][SerializeField] float highLandAmount = 0.6f;
                ...
                #region Gravity
                    ...
                    [MinMaxSlider(0f,1f)][SerializeField] float rayLength = 0.1f;
                    [MinMaxSlider(0.01f,1f)][SerializeField] float raySphereRadius = 0.1f;
                #endregion
                ...
                #region Wall Settings
                    ...
                    [MinMaxSlider(0f,1f)][SerializeField] float rayObstacleLength = 0.1f;
                    [MinMaxSlider(0.01f,1f)][SerializeField] float rayObstacleSphereRadius = 0.1f;
                ...
                #region Smooth Settings
                    ...
                    float smoothRotateSpeed = 5f;
                    [Range(1f,100f)] [SerializeField] float smoothInputSpeed = 5f;
                    [Range(1f,100f)] [SerializeField] float smoothVelocitySpeed = 5f;
                    [Range(1f,100f)] [SerializeField] float smoothFinalDirectionSpeed = 5f;
                    [Range(1f,100f)] [SerializeField] float smoothHeadBobSpeed = 5f;

                    [Space]
                    [SerializeField]
                    bool experimental = false;
                    [InfoBox("It should smooth our player movement to not start fast and not stop fast but it's somehow jerky")]
                    ...
                    [ShowIf("experimental")] [Range(1f,100f)] [SerializeField]
                    float smoothInputMagnitudeSpeed = 5f;
            ...
            #region Private Non-Serialized
                ...
                #region Debug
                    ...
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    Vector3 m_smoothFinalMoveDir;
                    [Space]
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    Vector3 m_finalMoveVector;

                    [Space]
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_currentSpeed;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_smoothCurrentSpeed;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_finalSmoothCurrentSpeed;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_walkRunSpeedDifference;

                    [Space]
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_finalRayLength;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    bool m_hitWall;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    bool m_isGrounded;
                    ...
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    Vector3 m_crouchCenter;
                    [Space]
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_initCamHeight;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_crouchCamHeight;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_crouchStandHeightDifference;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    bool m_duringCrouchAnimation;
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    bool m_duringRunAnimation;
                    [Space]
                    [BoxGroup("DEBUG")][SerializeField][ReadOnly]
                    float m_inAirTimer;

                    [Space]
                    [BoxGroup("DEBUG")][ShowIf("experimental")][SerializeField][ReadOnly]
                    float m_inputVectorMagnitude;
                    [BoxGroup("DEBUG")][ShowIf("experimental")][SerializeField][ReadOnly]
                    float m_smoothInputVectorMagnitude;
                #endregion
            #endregion
